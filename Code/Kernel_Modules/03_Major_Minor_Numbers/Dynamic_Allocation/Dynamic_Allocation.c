...
/*
Using this module:
Insert using: sudo insmod Dynamic_Allocation.ko
Remove Using: sudo rmmod Dynamic_Allocation.ko
*/
...
static int __init hello_world_init(void)
{
        ...
        if((alloc_chrdev_region(&dev, 0, 1, "Cesar Dynamic Major_Minor Driver")) <0){
